...
public class Calculator extends Frame implements ActionListener
{
	...
	public Calculator()
	{
		...
		//construct and assign caption to the Buttons
		for(int i=0; i<=9; i++)
		...
		//set Frame and keypad layout to grid laout
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (arg == "About")
		{
			String message = "This is a calculator\nAll rights reserved";
		...
		for(int i=0; i<keys.length && !foundKey; i++)
		{
			if(e.getSource() == keys[i])
			{
				...
				switch(i)
				{
					// number of decimal point buttons
