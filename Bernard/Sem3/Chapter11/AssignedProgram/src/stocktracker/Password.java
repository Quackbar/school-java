...
public class Password implements Serializable{
    ...
    public Password(String newPassword, int MaxUses, boolean pswdAutoExpires) throws PasswordException {
        pswdHistory = new ArrayList(maxHistory);
        autoExpires = pswdAutoExpires;
        set(newPassword);
    }
    ...
    public void setAutoExpires(boolean newExpired) {
    ...
    public int getExpiresNitifyLimit() {
    ...
    private void verifyFormat(String pswd) throws PasswordException{
        ...
        if(pswd.length() == 0)
            throw new PasswordInvalidException("Required password missing");
        ...
        if(!numFound)
            throw new PasswordInvalidException("Password is invalid -  must have at least one number");
    }
