...
class StockTracker extends JFrame implements ActionListener, WindowListener, Activator, STAction
{
    							...
    							throws ClassNotFoundException,SQLException
    {
        ...
        listTrans = new JButton("List Transactions");
        bsStock = new JButton("Buy or Sell Stocks");
	    ...
	    bsStock.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e)
    {
		...
		else if(e.getSource() == listTrans){
			try{
				ListTransFrame a = new ListTransFrame(this);
				setVisible(false);
				a.setVisible(true);
				}
				catch(Exception ex){
					System.out.println("Failed to open the List Transaction Window:" + ex.getMessage());
					ex.printStackTrace();
				}
		}
		else if(e.getSource() == bsStock){
			try{
			BuySellFrame a = new BuySellFrame(this);
			setVisible(false);
			a.setVisible(true);
			}
			catch(Exception ex){
				System.out.println("Failed to open the Buy Sell Stocks Window:" + ex.getMessage());
			}
		}
   		else
        {
