...
public class StockTrackerDB {
    ...
    //Constructor makes database connections
    public StockTrackerDB() throws ClassNotFoundException, SQLException{
        if(con == null){
        	String url = "jdbc:ucanaccess://Z:/Computer Science/Sem 3/Chapter 11/Assigned Program/StockTrackerDB2.accdb";
            try{
    ...
    //Close makes database connection; null reference top connection
    public void close() throws SQLException, IOException, ClassNotFoundException{
        con.close();
        con = null;
    }

    //Private method to serialize object to byte array
    ...
    private Object deserializedObj(byte[] buf) throws IOException, ClassNotFoundException{
        Object obj = null;
        if(buf != null){
    ...
    public boolean addUser(User user) throws SQLException, IOException, ClassNotFoundException{
        ...
        if(getUser(dbUserID) == null){
            ...
            throw new IOException("User exits - cannot add.");
        return result;
    }
    ...
    //////////////////////////////////////////////////////////////////////
    /////Methods for listing record date from a table
    //////////////////////////////////////////////////////////////////////
    ...
    public User getUser(String userID) throws SQLException, IOException, ClassNotFoundException{
        ...
        if(rs.next()){
            ...
            dbPswd = (Password)deserializedObj(buf);
    ...
    public ArrayList listUsers() throws SQLException, IOException, ClassNotFoundException{
        ...
        ResultSet rs = stmt.executeQuery("SELECT userID, firstName, lastName, admin " + "FROM Users ORDER BY UserID");
    ...
    public ArrayList listUserStocks(String userID) throws SQLException, ClassNotFoundException{
        ArrayList aList = new ArrayList();
        Statement stmt = con.createStatement();
