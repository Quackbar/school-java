...
public class MakeDB {
	public static void main(String[] args) throws Exception {
		...
		try{
			System.out.println("Creating StocksTrades table...");
			stmt.executeUpdate(
					"CREATE TABLE StockTrades (userID TEXT(20) NOT NULL, Stock TEXT(20) NOT NULL, BoughtOrSold TEXT(20) NOT NULL, Shares INTEGER NOT NULL, PricePerShare NUMBER NOT NULL, TotalPrice NUMBER NOT NULL, Date TEXT(30) NOT NULL)");
		}catch(Exception e){
