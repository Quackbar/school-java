/**
 * Created by bkintzing on 4/11/2017.
 */
import javax.swing.*;
import java.awt.*;
...
public class JDemoFontMetrics extends JPanel{
    ...
    Font courierItalic = new Font("Times New Roman", Font.PLAIN, 16), timesPlain = new Font("Times New Roman", Font.PLAIN, 16), scriptBold = new Font("Freestyle Script", Font.BOLD, 16);
