...
public class CreateFilesBasedOnState {
    public static void main(String[] args){
        ...
        Path inStateFile = Paths.get("Z:\\Computer Science\\Sem 6\\Chapter 13\\InStateCusts.txt");
        Path outOfStateFile = Paths.get("Z:\\Computer Science\\Sem 6\\Chapter 13\\OutOfStateCusts.txt");
